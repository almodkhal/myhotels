              ...
              <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4 col-sm-6 col-12 form-group">
                    <div class="card">
                        <?php if(isAdmin()): ?>
                        <div class="btn-group">
                            <button type="button" id="dltBtn_<?php echo e($room->id); ?>" class="btn btn-danger" onclick="removeRoom('<?php echo e($room->id); ?>')"><i class="fa fa-trash"></i></button>
                            <button type="button" class="btn btn-info" onclick="editRoom('<?php echo e($room->id); ?>','<?php echo ucwords($room->title); ?>','<?php echo $room->title; ?>','<?php echo $room->location; ?>','<?php echo e($room->rate); ?>','<?php echo e($room->availability); ?>','<?php echo e($room->status); ?>')"><i class="fa fa-edit"></i></button>
                        </div>
                        <?php endif; ?>
                        <div class="owl-carousel owl-theme room-image">
                            <?php $__currentLoopData = explode(',', $room->gallery); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item" style="background-image: url('<?php echo e(asset('/storage/uploads/rooms/'.$img)); ?>');"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <h4 class="room-title"><?php echo $room->title; ?></h4>
                        <h6 class="room-details">INR <?php echo e($room->rate); ?>/Day 
                            <span class="float-right"><?php echo e($room->availability); ?> Rooms</span></h6>
                        <p><i class="fa fa-map-marker"></i> <?php echo $room->location; ?> 
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="somthig" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form id="addForm" method="POST" action="<?php echo e(url('rooms')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="someOtherModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form id="editForm" action="<?php echo e(url('rooms/update')); ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
