        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                ...
                <select class="selectpicker" data-live-search="true" data-style="btn-light" name="manufacturer" id="manufacturer">
                    ...
                    <?php if($manufacturers!=FALSE): ?>
                     <?php $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $man): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($man->id); ?>"><?php echo e(strtoupper($man->manufacturer)); ?></option>
