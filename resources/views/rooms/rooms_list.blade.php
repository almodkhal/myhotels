    ...
    <div class="container">
        ...
        <div class="row justify-content-start form-group" style="background: #f1b504;padding: 10px;">
            <div class="col-md-4 col-6 sameLine">
                ...
                <input type="text" class="form-control datepicker" id="checkinDate" value="{{date('Y-m-d')}}">
            </div>
            <div class="col-md-4 col-6 sameLine">
                <label class="control-label">CheckOut:</label>
                <input type="text" class="form-control datepicker" id="checkoutDate" value="{{date('Y-m-d', strtotime('tomorrow'))}}">
            </div>
