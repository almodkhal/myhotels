...
<head>
  <meta charset="utf-8" />
  <title>{{ucwords($role)}} | {{config('app.name')}}</title>
      ...
      <div class="row login-page m-c">
        <div class="col-lg-4 col-md-5 login-right fullvh m-c">
            <div class="login-section">
                ...
                <div id="loginForm">
                  <h5 class="text-center"><span style="color: #dc3545;font-weight: bold;">{{ucwords($role)}}</span> Login</h5>
                  <form method="POST" action="{{ route('login') }}" autocomplete="off">
                       ...
                       <div class="text-center">
                         <a href="{{ url('/') }}" class="btn btn-danger btn-sm"><i class="fa fa-arrow-circle-left"></i> My Hotels</a>
                       </div>
                   </form>
                  </div>
                  {{-- Forgot pasword form --}}
