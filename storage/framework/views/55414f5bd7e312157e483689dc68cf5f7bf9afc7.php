    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12">
                ...
                <tbody>
                	<?php if($manufactures!=FALSE): ?>
                	<?php $i=1; ?>
                		<?php $__currentLoopData = $manufactures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $man): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                		<?php $__currentLoopData = $man->models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                			<?php if(count($model->cars)>0): ?>
		                		<tr class="modelRow" data-modal="<?php echo e($model->id); ?>">
		                		 	<td><?php echo e($i++); ?></td>
		                		 	<td class="manufacturerName"><?php echo e(strtoupper($man->manufacturer)); ?></td>
		                		 	<td class="modelName"><?php echo e(ucwords($model->model)); ?></td>
		                		 	<td align="center"><?php echo e(count($model->cars)); ?></td>
		                		</tr>
		                		<?php endif; ?>
		...
		$.ajax({
	        ...
	        success: function (res) {
	        	if(res==1) {
					...
					setTimeout(function(){ 
			           window.location.href = "<?php echo e(url('inventory')); ?>";
			        }, 2000);
	        	}else {
