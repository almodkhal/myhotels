        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">Create Project</h4>
                    <a href="<?php echo e(url('projects')); ?>" class="btn btn-primary btn-rounded waves-light waves-effect float-right"><i class="fa fa-briefcase"></i> Project List</a>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card-box pt-0">
                    <form id="addForm" class="form" action="<?php echo e(url('projects')); ?>" method="POST" autocomplete="off">
                        <?php echo csrf_field(); ?>
                        ...
                        <section>
                            <div class="row">
                                <div class="col-lg-2 col-md-3 form-group">
                                    ...
                                    <input type="text" class="form-control" id="projectID" name="projectID" value="<?php echo e($nextCode); ?>" readonly>
                                </div>
                            ...
                            <div class="row">
                                                ...
                                                <select class="selectpicker" data-live-search="true" data-style="btn-light" id="project" name="project">
                                                    ...
                                                    <?php if($projectNames!=FALSE): ?>
                                                        <?php $__currentLoopData = $projectNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($name->id); ?>"><?php echo e(ucwords($name->projectname)); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                </select>
                                            </span>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <textarea class="form-control" name="projectDetails" id="projectDetails" style="height: 117px;"></textarea>
                                </div>
                            </div>
                        </section>
