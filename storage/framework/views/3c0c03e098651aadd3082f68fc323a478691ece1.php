...
<div class="row justify-content-center">
    <div class="col-md-12 col-lg-8">
        <div class="card-box pt-0 form">
            ...
            <table class="table table-bordered mb-0" id="permissionsTbl">
                <thead>
                    <tr>
                        <th width="10%">#</th>
                ...
                <tbody id="rolesList">
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="rolesRow_<?php echo e($role->id); ?>">
                            ...
                            <td align="center">
                                <?php if($role->editable==1): ?>
                                <button type="button" onclick="showPermissions(<?php echo e($role->id); ?>)" class="btn btn-warning waves-light waves-effect"><i class="fa fa-key"></i></button>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<div id="permission-modal" class="modal-demo">
    ...
    <h4 class="custom-modal-title">Modify Permissions for "<span id="addedRole"></span>"</h4>
    <div class="custom-modal-text">
        ...
        <form class="form" action="<?php echo e(url('masters/permissions')); ?>" method="POST" autocomplete="off">
            ...
            <table class="table table-hover table-stripped table-bordered mb-0">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Forms</th>
...
<div id="edit-permission-modal" class="modal-demo">
    ...
    <h4 class="custom-modal-title">Modify Permissions for "<span id="edittingRole"></span>"</h4>
    <div class="custom-modal-text">
